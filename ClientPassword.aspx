<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="ClientPassword.aspx.cs" Inherits="ClientPassword" %>
 ...
 <tr>
        ...
        <tr>
          <td align =center colspan =2 >
              <asp:Button ID="btnSubmitt" runat =server Text ="Submit" onclick="btnSubmitt_Click" 
                  />
