<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewFinancial.aspx.cs" Inherits="Company_ViewFinancial" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <p  class="lvtHeaderText">View Financial Year </p>
  </div>
...
<tr>
 ...
 <div class="mGrid1"  Width="100%" id="Div1" style="width:100%;border-collapse:collapse; padding-top:0px; text-align:center">
            ...
            <asp:ImageButton ID="imgInvoice" ImageUrl ="../images/edit.png" runat="server" CommandName ="Edit" ToolTip ="Click to Edit" CausesValidation ="false"   /> 
                ...
                <asp:TemplateField HeaderText="Document_id" Visible= "false">
                                    <ItemTemplate>
                                     <asp:Label ID="lblserialno" runat="server" Text ='<%#Eval("f_id") %>' />
                                      
                                    </ItemTemplate>
                                </asp:TemplateField>
                                 <asp:BoundField DataField ="f_id" HeaderText ="SNo."/>
                              <asp:BoundField DataField ="f_name" HeaderText ="Financial Year"/>
