<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Request.aspx.cs" Inherits="Request_Request" %>
...
<div class="rightside">
  ...
  <p  class="lvtHeaderText">Request</p>
  </div>
  ...
  <td valign="middle" class="dvtCellLabel col-sm-2 control-label ">
   ...
   <td valign="left" class="cellInfo1 ">    
      <asp:DropDownList ID="ddstatus" CssClass="dropdown" runat="server">
       ...
       <asp:ListItem>Need Discuss</asp:ListItem> 
    ...
    <td valign="middle" class="cellInfo1 " colspan="2" align="center">
       <asp:Button ID="Btn_Submit" runat="server" Text="Save" 
        onclick="Btn_Submit_Click" ForeColor="#FF3300" Font-Bold="True" Width="94px" />
